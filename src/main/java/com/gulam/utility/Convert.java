    ...
    public static JSONObject toJson(Map<String, Object> map) {
        ...
        for (String key : map.keySet()) {
            try {
                ...
                System.out.println("Failed to get value from JSONObject.");
            }
        }
    ...
    public static Map<String, Object> fromJson(JSONObject jsonObject) {
        ...
        while (keyIterator.hasNext()) {
            ...
            try {
                ...
                System.out.println("Failed to get value for " + key + " from JSONObject.");
            }
        }
    ...
    public static List<Object> fromJson(JSONArray jsonArray) {
        ...
        for (int i = 0; i < jsonArray.length(); i++) {
            try {
                ...
                System.out.println( "Failed to get value at index " + i + " from JSONArray.");
            }
        }
